...
Shader "Plant1Shader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float3 temp_cast_1 = (lerpResult17).xxx;
			float mulTime40 = _Time.y * -0.2;
			float3 ase_objectScale = float3( length( unity_ObjectToWorld[ 0 ].xyz ), length( unity_ObjectToWorld[ 1 ].xyz ), length( unity_ObjectToWorld[ 2 ].xyz ) );
			float3 lerpResult43 = lerp( temp_cast_1 , ( lerpResult17 + ( sin( ( ( v.texcoord.xy.y * 10.0 ) + mulTime40 + ase_objectScale ) ) * float3( 0.005,0,0 ) ) ) , v.texcoord.xy.y);
			float3 appendResult32 = (float3(ase_vertex3Pos.x , lerpResult43.x , ase_vertex3Pos.z));
...
Node;AmplifyShaderEditor.ObjectScaleNode;61;-570.3177,949.115;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleAddOpNode;39;-324.4272,793.0555;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SinOpNode;41;-173.2851,842.0693;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-37.6526,879.342;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0.005,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleAddOpNode;33;123.1121,616.5438;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;43;331.0963,511.5189;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=1EE1A559AFD5BA3DB0FFCD5187545A90CE251C55