...
Shader "Plant1Shader"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float lerpResult43 = lerp( lerpResult17 , ( lerpResult17 + ( sin( ( ( v.texcoord.xy.y * 10.0 ) + mulTime40 ) ) * 0.001 ) ) , v.texcoord.xy.y);
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 objToWorld67 = mul( unity_ObjectToWorld, float4( ( ase_vertex3Pos * float3( 0,0,0 ) ), 1 ) ).xyz;
			o.Emission = objToWorld67;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18912
84.8;531.2;1523.2;795;1756.583;387.0312;1.976849;True;False
...
Node;AmplifyShaderEditor.SimpleTimeNode;40;-774.4672,812.4832;Inherit;False;1;0;FLOAT;-0.2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-825.0854,158.9267;Inherit;False;Property;_Float0;Float 0;0;0;Create;True;0;0;0;False;0;False;1;0.72;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;38;-6.023021,873.4114;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.001;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.PosVertexDataNode;63;-889.572,1161.153;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;64;-648.5721,1173.153;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;53;230.0867,-605.1605;Inherit;False;Property;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5896226,1,0.9356106,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ObjectScaleNode;61;-789.3177,965.115;Inherit;False;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TransformPositionNode;67;-450.7856,1159.598;Inherit;False;Object;World;False;Fast;True;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=BF9C832C8DAE06012E25342ED3C3F7C007504851